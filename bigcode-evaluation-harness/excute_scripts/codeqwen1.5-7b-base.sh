...
export OPENAI_BASE_URL='http://210.28.134.32:8801/v1/completions'
export MODEL_ID=CodeQwen1.5-7B
export concurrency=15
MODEL_NAME=codeqwen1.5-7b-base
MODEL_TYPE=causal_base
MODEL_SERIES=codeqwen
MODEL_PATH=/data1/ljc/qwen/Qwen/CodeQwen1.5-7B
...
mbpp_generate_python_robust_no_change,mbpp_generate_python_robust_rename,\
mbpp_generate_python_robust_code_stmt_exchange,mbpp_generate_python_robust_code_expression_exchange,\
mbpp_generate_python_robust_insert,mbpp_generate_python_robust_code_style,\
mbpp_generate_cpp_robust_no_change,mbpp_generate_cpp_robust_rename,mbpp_generate_cpp_robust_code_stmt_exchange,\
mbpp_generate_cpp_robust_code_expression_exchange,\
mbpp_generate_cpp_robust_insert,mbpp_generate_cpp_robust_code_style,\
...
mbpp_generate_java_robust_no_change,mbpp_generate_java_robust_rename,mbpp_generate_java_robust_code_stmt_exchange,\
mbpp_generate_java_robust_code_expression_exchange,mbpp_generate_java_robust_insert,mbpp_generate_java_robust_code_style,\
